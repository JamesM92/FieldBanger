...
Operation:
-User will connect the FieldBanger to the Scarebanger
-Led on FieldBanger will blink till it is initialized
...
-While pressing the buttons during the program sequence the relays on the Scarebanger will trigger in response.
-Once complete the user will press the record button again to end the sequence, and the FieldBanger will start sending the new sequence to the octobanger.
...
Pin Mapping
Arduino Nano
[0/1] Tx/Rx - Used to transmit seriall commands to ScareBanger Baud:115200
[2] Btn_1
[3] Btn_2
[4] Btn_3
[5] Btn_4
...
The sequence is stored EEPROM of the Scarebanger, the EEPROM is about half the size of the sram, 
Nano EEPROM : 1KB
Mega EEPROM : 4KB
